...
import standrews.classification.DeeplearningClassifierFactory;
...
import standrews.constextract.HatExtractorAnalysis;
...
public class Experiments {
	...
	private static FeatureSpecification hatSpec(
		...
		spec.setIntsFeature("inputPoss", 0, 2);
		spec.setIntsFeature("inputForms", 0, 2);
		// spec.setIntsFeature("stackCats", 0, 2);
		// spec.setIntsFeature("stackPoss", 0, 2);
		// spec.setIntsFeature("stackForms", 0, 2);
		// spec.setIntsFeature("leftCats", 0, 1);
		// spec.setIntsFeature("rightCats", 0, 1);
		spec.setIntsFeature("hatCats", -3, 3);
		spec.setIntsFeature("hatPoss", -3, 3);
		spec.setIntsFeature("hatForms", -3, 3);
	...
	public static HatExtractor trainHat(
		...
		final HatExtractor extractor =
				new HatExtractor(treebank, spec,
	...
	public static void trainTestSimple(
		...
		final SimpleExtractor extractor = trainSimple(lang, treebank, nTrain, spec,
				leftFirst, projectivize);
	...
	public static void trainTestHat(
		...
		final HatExtractor extractor = trainHat(lang, treebank, nTrain, spec,
